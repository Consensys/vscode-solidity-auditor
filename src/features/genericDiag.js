...
class DiliDiagnosticCollection {
  constructor(context, base, issueFileGlob) {
    ...
    this.collections = {};
    this.issueFileGlob = issueFileGlob
      ? issueFileGlob
            ...
            uris.forEach(function (uri) {
              ...
              try {
                ...
                issues.forEach(function (issue) {
                  //abspath or relpath?
                  let targetFileUri = issue.onInputFile.startsWith("/")
                    ? issue.onInputFile
                  ...
                  pathToIssues.get(targetFileUri.fsPath).push({
                    ...
                    range: new vscode.Range(
                      new vscode.Position(issue.atLineNr - 1, 0),
                      new vscode.Position(issue.atLineNr - 1, 255),
                    ),
